...
Настроенный ключ ещё не значит, что письмо реально дойдёт: если
MAIL_DEFAULT_SENDER — это onboarding@resend.dev (значение из .env.example
"из коробки", тестовый адрес самого Resend), Resend отклонит отправку 403
"Testing domain restriction" на любой email, кроме того, на который
зарегистрирован сам Resend-аккаунт — до тех пор, пока в Resend не
подтверждён свой домен. См. .env.example для инструкции."""
import json
import urllib.error
