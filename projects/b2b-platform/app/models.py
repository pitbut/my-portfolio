...
NOTIFICATION_TYPES = (
    "new_order_match", "new_order_broadcast", "outbid", "bid_accepted", "bid_rejected", "assignment_cancelled",
    "order_completed", "dispute_update", "subscription_expiring", "subscription_activated", "review_received",
